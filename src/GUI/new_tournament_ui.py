...
class Ui_NewTournament(object):
    ...
    def retranslateUi(self, NewTournament):
        ...
        self.type_cb.setItemText(0, _translate("NewTournament", "Round Robin (16 or Less players)"))
        self.type_cb.setItemText(1, _translate("NewTournament", "Swiss ( 17 - 64 Players)"))
        self.type_cb.setItemText(2, _translate("NewTournament", "Double Elimination ( 33 - 120 Players)"))
        self.type_cb.setItemText(3, _translate("NewTournament", "Single Elimination (120 + Players)"))
